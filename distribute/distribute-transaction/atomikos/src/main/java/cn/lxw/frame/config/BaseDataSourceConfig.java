...
public class BaseDataSourceConfig {
    ...
    @Primary
    @Autowired
    public DataSource studentDataSource(Environment env) {
        AtomikosDataSourceBean ds = new AtomikosDataSourceBean();
        Properties prop = build(env, "spring.datasource.druid.studentdb.");
        ds.setXaDataSourceClassName("com.alibaba.druid.pool.xa.DruidXADataSource");
        ds.setUniqueResourceName("studentDb");
        ds.setPoolSize(5);
    ...
    public AtomikosDataSourceBean courseDataSource(Environment env) {
        AtomikosDataSourceBean ds = new AtomikosDataSourceBean();
        Properties prop = build(env, "spring.datasource.druid.coursedb.");
        ds.setXaDataSourceClassName("com.alibaba.druid.pool.xa.DruidXADataSource");
        ds.setUniqueResourceName("courseDb");
        ds.setPoolSize(5);
        ds.setXaProperties(prop);
        return ds;
    }
