...
@Configuration
@MapperScan(basePackages = "cn.lxw.frame.studentdb",sqlSessionFactoryRef = "studentSqlSessionFactory")
public class StudentMybatisConfig {
    ...
    public SqlSessionFactory studentSqlSessionFactory() throws Exception {
        ...
        sessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mapper/studentdb/*Mapper.xml"));
